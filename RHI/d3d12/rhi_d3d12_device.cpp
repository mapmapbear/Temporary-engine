...
RHIBuffer* D3D12Device::CreateBuffer(const RHIBufferDesc& desc, const std::string& name)
{
...
RHITexture* D3D12Device::CreateTexture(const RHITextureDesc& desc, const std::string& name)
{
...
RHISwapchain* D3D12Device::CreateSwapchain(const RHISwapchainDesc& desc, const std::string& name)
{
...
RHICommandList* D3D12Device::CreateCommandList(RHICommandQueue queue_type, const std::string& name)
{
...
RHIShader* D3D12Device::CreateShader(const RHIShaderDesc& desc, const std::vector<uint8_t>& data, const std::string& name)
{
	return new D3D12Shader(this, desc, data, name);
}

RHIPipelineState* D3D12Device::CreateGraphicsPipelineState(const RHIGraphicsPipelineDesc& desc, const std::string& name)
{
...
RHIPipelineState* D3D12Device::CreateMeshShadingPipelineState(const RHIMeshShadingPipelineDesc& desc, const std::string& name)
{
	//todo
	return nullptr;
}

uint32_t D3D12Device::CreateShaderResourceView(RHIResource* resource, const RHIShaderResourceViewDesc& desc)
{
	return uint32_t();
}

uint32_t D3D12Device::CreateUnorderedAccessView(RHIResource* resource, const RHIUnorderedAccessViewDesc& desc)
{
	return uint32_t();
}

uint32_t D3D12Device::CreateConstantBufferView(RHIBuffer* buffer, const RHIConstantBufferViewDesc& desc)
{
	return uint32_t();
}

uint32_t D3D12Device::CreateSampler(const RHISamplerDesc& desc)
{
