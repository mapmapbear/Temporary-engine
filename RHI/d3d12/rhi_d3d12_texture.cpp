...
static inline D3D12_RESOURCE_DESC d3d12_resource_desc(const RHITextureDesc& desc)
{
...
D3D12Texture::D3D12Texture(D3D12Device* pDevice, const RHITextureDesc& desc, const std::string& name)
{
	m_pDevice = pDevice;
	m_desc = desc;
	m_name = name;
...
bool D3D12Texture::Create()
{
	...
	allocationDesc.Flags = m_desc.alloc_type == RHIAllocationType::Committed ? D3D12MA::ALLOCATION_FLAG_COMMITTED : D3D12MA::ALLOCATION_FLAG_NONE;
